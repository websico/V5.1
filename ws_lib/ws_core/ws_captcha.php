...
$char6 = substr($mot,5,1);
$char7 = substr($mot,6,1);
$char8 = substr($mot,7,1);
...
imagettftext($img, 28, -10, 160, 33, $col1, $font2, $char6);
imagettftext($img, 28, 15, 190, 33, $col2, $font2, $char7);
imagettftext($img, 28, 15, 220, 37, $col1, $font, $char8);
